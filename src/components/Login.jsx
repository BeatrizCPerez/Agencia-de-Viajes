...
const Login = () => {
  ...
  <div className="rounded-t  mb-0 px-6 py-6">
            ...
            <div className="btn-wrapper text-center">
              <button className="bg-white active:bg-blueGray-90 text-blueGray-700 font-normal px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs ease-linear transition-all duration-150" type="button">
          ...
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <form>
              <div className="relative w-full mb-3">
                <label className="block uppercase text-white text-xs font-bold mb-2" htmlFor="grid-password">Email</label>
              ...
              <div className="relative w-full mb-3">
                <label className="block uppercase text-white text-xs font-bold mb-2" htmlFor="grid-password">Password</label>
