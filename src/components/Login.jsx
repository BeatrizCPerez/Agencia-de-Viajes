...
const Login = () => {
  return (
    ...
    <Nav />
      ...
      <div className="relative flex mt-[100px] flex-col min-w-0 break-words w-full mb-6 shadow-lg bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg bg-blueGray-200">
